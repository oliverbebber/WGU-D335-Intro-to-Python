...
print(our_list)  # Outputs: ['rose', 'peony', 'lily', 'rose', 'daisy']

# 4. TODO: Append their_flower to the end of our_list
our_list.append(their_flower)
print(our_list)  # Outputs: ['rose', 'peony', 'lily', 'rose', 'daisy', 'aster']

# 5. TODO: Replace my_flower2 in our_list with their_flower
our_list[1] = their_flower
print(our_list)  # Outputs: ['rose', 'aster', 'lily', 'rose', 'daisy', 'aster']

# 6. TODO: Remove the first occurrence of their_flower from
# our_list without using index()
our_list.remove(their_flower)  # NOTE: pop() removes by index, use remove() to remove by specific value(s)
print(our_list)

# 7. TODO: Remove the second element of our_list
our_list.pop(1)  # NOTE: we could use del our_list[1] 
print(our_list)
